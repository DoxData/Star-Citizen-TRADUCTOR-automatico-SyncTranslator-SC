...
Descargar: [SyncTranslator SC en GitHub](https://github.com/DoxData/Star-Citizen-TRADUCTOR-automatico-SyncTranslator-SC/releases/download/SyncTranslatorSC.v1/SyncTranslator.SC.zip)
